...
const Navbar = ({token}) => {
  ...
  useEffect(()=>{
    const fetchProducts = async()=>{
      try{
        const res = typeof(window)!=="undefined" &&  await axios.get(`${window.location.origin}/api/product/find/`)
  ...
  return (
    <div className={styles.Container}>
     <div className={styles.Left}>
       ...
       <ul style={{position:"absolute",backgroundColor:"white",color:"black",padding:0,listStyle:"none",width:"100%",boxShadow:"0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)"}}>
