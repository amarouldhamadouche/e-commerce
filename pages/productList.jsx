...
export const getServerSideProps =  async(ctx)=>{
  ...
  const res =!cat ? await axios.get(`https://${ctx.req.rawHeaders[1]}/api/product/find`) :  await axios.get(`https://amarouldhamadoucheecommerce.herokuapp.com/api/product/find?categorie=${cat}`)
  return {
    props : {
